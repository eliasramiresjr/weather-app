...
//  Weather App
//
//  Created by Elias Ramires Júnior on 18/05/24.
//
...
class ViewController: UIViewController {
    ...
    private var city = City(lat: "-23.5475", lon: "-46.6361", name: "São Paulo")
    ...
    private func loadData() {
        ...
        windValueLabel.text = "\(forecastResponse?.current.windSpeed ?? 0)km"
